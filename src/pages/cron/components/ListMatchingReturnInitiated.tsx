...
import styles from './ListMatchingReturnInitiated.less';
...
const ListMatchingReturnInitiated = (props: Props) => {
  ...
  const renderTitle = () => (
    <Row type="flex" justify="space-between" align="middle">
      <Tooltip title="track_matching_return_initiated">
        <strong>Matchings Return Initiated In Future</strong>
      </Tooltip>
      <Button
        loading={dispatching}
        onClick={() => onDispatchJob && onDispatchJob('track_matching_return_initiated')}
      >
        Dispatch Job
      </Button>
    </Row>
...
export default ListMatchingReturnInitiated;
