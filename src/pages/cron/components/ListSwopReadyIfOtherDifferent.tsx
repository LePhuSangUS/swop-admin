...
import styles from './ListSwopReadyIfOtherDifferent.less';
...
const ListSwopReadyIfOtherDifferent = (props: Props) => {
  ...
  const renderTitle = () => (
    <Row type="flex" justify="space-between" align="middle">
      <Tooltip title="track_swop_ready_if_other_different">
        <strong>Swops Ready Awaiting</strong>
      </Tooltip>
      <Button
        loading={dispatching}
        onClick={() => onDispatchJob && onDispatchJob('track_swop_ready_if_other_different')}
      >
        Dispatch Job
      </Button>
    </Row>
    ...
    <>
      ...
      <div className={styles.footer}>
        ...
        <div className={styles.footerTag}>
          <span>
            ...
            <ul>
              <li>
                If other swop is{' '}
                <Tag color={getSwopStatusColor('un_picked')}>
                  {getSwopStatusDisplay('un_picked')}
                </Tag>{' '}
                or{' '}
                <Tag color={getSwopStatusColor('different')}>
                  {getSwopStatusDisplay('different')}
                </Tag>{' '}
                will mark this to{' '}
              ...
              <li>
                If other swop is{' '}
                <Tag color={getSwopStatusColor('ready')}>{getSwopStatusDisplay('ready')}</Tag> or{' '}
                <Tag color={getSwopStatusColor('received')}>{getSwopStatusDisplay('received')}</Tag>{' '}
                will mark this to{' '}
                <Tag color={getSwopStatusColor('delivery_scheduled')}>
                  {getSwopStatusDisplay('delivery_scheduled')}
                </Tag>{' '}
              </li>
            </ul>
          </span>
        ...
        <div>
          ...
          Swop's status is{' '}
          <Tag color={getSwopStatusColor('ready')}>{getSwopStatusDisplay('ready')}</Tag> Counter
          Swop's status is{' '}
          <Tag color={getSwopStatusColor('un_picked')}>{getSwopStatusDisplay('un_picked')}</Tag>
          {' or '}
          <Tag color={getSwopStatusColor('different')}>
            {getSwopStatusDisplay('different')}
          </Tag>{' '}
...
export default ListSwopReadyIfOtherDifferent;
