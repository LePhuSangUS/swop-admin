...
import styles from './ListSwopReady.less';
...
const ListSwopReady = (props: Props) => {
  ...
  const renderTitle = () => (
    <Row type="flex" justify="space-between" align="middle">
      <Tooltip title="track_swop_ready">
        <strong>Swops Ready</strong>
      </Tooltip>
      <Button
        loading={dispatching}
        onClick={() => onDispatchJob && onDispatchJob('track_swop_ready')}
      >
        Dispatch Job
      </Button>
    </Row>
