...
const ListSwopPickUpScheduledIfOtherDifferent = (props: Props) => {
  ...
  const renderTitle = () => (
    <Row type="flex" justify="space-between" align="middle">
      <Tooltip title="track_swop_pick_up_scheduled_if_other_different">
        <strong>Swops Pick Up Scheduled Awaiting</strong>
      </Tooltip>
      <Button
        loading={dispatching}
        onClick={() =>
          onDispatchJob && onDispatchJob('track_swop_pick_up_scheduled_if_other_different')
        }
      >
        Dispatch Job
      </Button>
  ...
  return (
    <>
      ...
      <div className={styles.footer}>
        ...
        <div className={styles.footerTag}>
          <span>
            <strong>Note: </strong>If swop is ready and counter swop status is either different or
            un-picked, will mark as return delivery scheduled
          </span>
        </div>
        <div>
...
export default ListSwopPickUpScheduledIfOtherDifferent;
