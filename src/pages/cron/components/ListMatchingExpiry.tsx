...
import styles from './ListMatchingExpiry.less';
...
const ListMatchingExpiry = (props: Props) => {
  ...
  const renderTitle = () => (
    <Row type="flex" justify="space-between" align="middle">
      <Tooltip title="track_matching_expiry">
        <strong>Matching Expiry In Future</strong>
      </Tooltip>
      <Button
        loading={dispatching}
        onClick={() => onDispatchJob && onDispatchJob('track_matching_expiry')}
      >
        Dispatch Job
      </Button>
    </Row>
...
export default ListMatchingExpiry;
