...
class FilterModal extends React.PureComponent<IModalProps> {
  ...
  handleOk = () => {
    ...
    validateFields((errors: any) => {
      ...
      switch (data['is_delist']) {
        case 'Yes':
          data['is_delist'] = true;
          break;
        case 'No':
          data['is_delist'] = false;
          break;
        default:
          delete data['is_delist'];
          break;
      }
          ...
          <Form layout="horizontal">
            ...
            <Form.Item labelAlign="left" label="Is Delist" {...formItemLayout}>
              {getFieldDecorator('is_delist', {
                initialValue:
                  typeof filter?.is_delist === 'boolean'
                    ? filter?.is_delist
                      ? 'Yes'
                      : 'No'
                    : 'None',
                ...
                <Select>
                  <Select.Option key="is_delist_yes" value="Yes">
                    Yes
                  </Select.Option>
                  <Select.Option key="is_delist_no" value="No">
                    No
                  </Select.Option>
                  <Select.Option key="is_delist_none" value="None">
                    None
                  </Select.Option>
                </Select>,
              )}
