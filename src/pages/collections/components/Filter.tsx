...
class Filter extends React.Component<IFilterProps> {
  ...
  render() {
    const { onCreate, filter, form } = this.props;
      ...
      <Row gutter={24}>
        <Col {...ColProps} xl={{ span: 6 }} md={{ span: 8 }}>
          ...
          <div style={{ marginTop: 10 }}>
            <Typography.Text type="secondary">Searchable fields: Name</Typography.Text>
          </div>
        </Col>
        ...
        <Col {...TwoColProps} xl={{ span: 18 }} md={{ span: 16 }} sm={{ span: 24 }}>
          <Row type="flex" align="middle" justify="space-between">
            ...
            <div>
              <Button className="margin-right" type="primary" onClick={onCreate}>
                Create
              </Button>
            </div>
          </Row>
