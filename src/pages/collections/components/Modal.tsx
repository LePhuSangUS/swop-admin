...
import { IConstants, ICollection, IFormProps } from 'types';
...
class CollectionModal extends React.PureComponent<IModalProps> {
  handleOk = () => {
    ...
    return (
      <Modal {...modalProps} onOk={this.handleOk}>
        ...
        <Form layout="horizontal">
          ...
          <Form.Item labelAlign="left" label="Name" hasFeedback={true} {...formItemLayout}>
...
export default Form.create<IModalProps>()(CollectionModal);
